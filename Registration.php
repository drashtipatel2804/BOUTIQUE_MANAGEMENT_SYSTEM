    ...
    <body onload="myfun()">
        ...
        <script>
                            ...
                            function validateForm() {
                                ...
                                showLoader(); // Show the loader before submitting the form
                                return true;
                            ...
                            function showLoader() {
                                ...
                                var preloaderMain = document.getElementById('ftco-loader');
                                if (preloader) {
                                    preloader.style.display = 'flex'; // Display the loader when called
                                    preloaderMain.classList.add('show')
                                }
                            }
                            ...
                            function hideLoader() {
                                ...
                                if (preloader) {
                                    ...
                                    preloaderMain.classList.remove('show')
