                ...
                <ul class="d-flex align-items-center">
                    <li class="nav-item dropdown pe-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="customerProfile.php">
                                    <i class="bi bi-person"></i>
                                    <span>My Profile</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="ChangePassword.php"><!--link change password page -->
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="signout_c.php">
