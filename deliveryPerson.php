...
//$sql1 = "SELECT fname, lname , email, address, FROM tbluser WHERE email='$email'";
//for edit profile
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        ...
        .btn-custom:hover {
            ...
            border-color: #f0f0f0;
            /* Highlighting the border color on hover */
        }
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="IMG/FashionHub.jpg" alt="Boutique Logo">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="deliveryPerson.php">Home</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                        ...
                        <div class="card-body pt-3">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if (mysqli_num_rows($result_cityshow) > 0) {
                                                ...
                                                //                                                echo "<p><strong>City:</strong> " . $row["cityname"] . "</p>";
                                                //                                                    echo "<p><strong>Contact No:</strong> " . $row["contactno"] . "</p>";
                                                //                                                    echo "<p><strong>Email:</strong> " . $row["email"] . "</p>";
                                                echo "</div>";
                                            }
                            ...
                            <form method="post" action="" name="editProfile" onsubmit="return validateForm()">
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!--                                        <div class="row mb-3">
                                                                                    ...
                                                                                    <div class="col-md-8 col-lg-9">
                                                                                        <label><input type="radio" name="gender" value="female"> Male
                                                                                        </label>
                                                                                        <label><input type="radio" name="gender" value="male"> Female
                                                                                        </label>
                                                                                        <label>
                                    ...
                                    <!--                                        <div class="row mb-3">
                                                                                    ...
                                                                                    <div class="col-md-8 col-lg-9">
                                                                                        <input name="email" type="email" class="form-control" id="Email" value="<?php echo $email1; ?>">
                            ...
                            <script>
                                function validateForm() {
                                    ...
                                    if (/\d/.test(lastName)) {
                                        firstNameError.textContent = "Last name cannot contain digits.";
                                        return false;
                                    }
