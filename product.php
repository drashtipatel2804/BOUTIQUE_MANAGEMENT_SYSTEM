...
if (isset($_POST['add'])) {
    ...
    if (isset($_FILES['image1'])) {
        ...
        $image1Path = 'IMG/' . $image1Name; // Modify the path as needed
    ...
    if (isset($_FILES['image2'])) {
        ...
        $image2Path = 'IMG/' . $image2Name; // Modify the path as needed
...
<html lang="en">
        ...
        <div class="container mt-5">
            <div class="d-flex justify-content-center align-items-center">
                <div class="form-container">
                    <form name="add_product" onsubmit="return validateForm()" method="post"  enctype="multipart/form-data" >
    ...
    <script>
        function validateForm() {
            var productName = document.forms["add_product"]["productName"].value;
            var category = document.forms["add_product"]["category"].value;
            var size = document.forms["add_product"]["size"].value;
            var color = document.forms["add_product"]["color"].value;
            var fabric = document.forms["add_product"]["fabric"].value;
            var price = document.forms["add_product"]["price"].value;
            var quantity = document.forms["add_product"]["quantity"].value;
